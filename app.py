...
def login():
    ...
    if username and password: 
        user = User.query.filter_by(username=username).first() # buscar no banco

        if user and user.password == password:
            login_user(user) # autenticação do usuario
            print(current_user.is_authenticated) # print da autenticação
